...
public class Column implements java.io.Serializable,Cloneable{
	...
	public Column(Table table, int sqlType, String sqlTypeName,
			String sqlName, int size, int precision, int decimalDigits, boolean isPk,
	...
	/*public boolean getIsQueryReserve(){
		return "ID".equalsIgnoreCase(columnName) 
				|| "createDate".equalsIgnoreCase(columnName) 
				|| "updateDate".equalsIgnoreCase(columnName);
	}*/
	public boolean getIsQueryReserve(){
		return "ID".equalsIgnoreCase(columnName) 
				|| "createTime".equalsIgnoreCase(columnName) 
				|| "updateTime".equalsIgnoreCase(columnName);
	}
