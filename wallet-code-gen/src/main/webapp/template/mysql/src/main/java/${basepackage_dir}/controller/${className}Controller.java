...
import com.hrsf.paging.PageView;
import com.hrsf.paging.Pagenation;
import com.hrsf.web.BaseController;
import com.hrsf.web.ReturnObject;
...
public class ${className}Controller extends BaseController {
	...
	public ModelAndView ${classNameLower}View(int id, HttpSession session) throws Exception {
	...
	public ModelAndView ${classNameLower}Edit(int id, HttpSession session) throws Exception {
	...
	@ResponseBody
	public ReturnObject ${classNameLower}EditSubmit(int id, ${className}Query ${classNameLower}Query, HttpSession session) {
	...
	@ResponseBody
	public ReturnObject ${classNameLower}Del(int id, HttpSession session) {
