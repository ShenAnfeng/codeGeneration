...
<script type="text/javascript">
	...
	function _submit() {
		$('#addForm').form('submit', {
		    url:'${classNameLower}Controller/${classNameLower}AddSubmit', 
		    ajax:true,
		    onSubmit:function(){
...
<div class="titleDetail">${table.remarks }--新增</div>
<div class="selectContentDiv">
    <form action="${classNameLower}Controller/${classNameLower}AddSubmit" method="post" id="addForm" name="addForm">
